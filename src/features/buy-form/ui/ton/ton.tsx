...
export const Ton = ({ onBuyClick }: Props) => {
	...
	return (
		<>
			...
			<div className="mb-[24px] flex flex-col gap-2 md:mb-[33px]">
				...
				<div className="flex items-center gap-2 rounded-[12px] bg-[#EAEEF0] px-4 py-2.5">
					...
					<input
						...
						className="font-montserrat w-full bg-transparent py-1.5 text-[16px]/[22.8px] font-medium text-[#1D2123] outline-none placeholder:text-[#95A0A7]"
					/>
			...
			<p className="font-inter relative -top-[3px] text-center text-[14px] leading-[22.8px] text-[#95A0A7] lg:text-[16px]">
