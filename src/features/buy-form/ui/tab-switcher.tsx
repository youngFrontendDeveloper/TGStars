...
export const TabSwitcher = ({
	...
	return (
		<>
			<div className="mx-auto hidden h-12 w-max rounded-[68px] bg-[#EAEEF0] p-1 sm:flex">
				{items.map((item) => (
					<button
						key={item.id}
						onClick={() => onTabChange(item.id)}
						className={clsx(
							"font-mts-text flex items-center gap-2 rounded-[68px] p-0.5 px-[14px] py-3 text-sm/[100%] font-medium text-[#808080] transition-colors",
...
const MobileTabSwitcher = ({
	...
	return (
		<div className="relative mx-auto w-full max-w-[90vw] sm:hidden">
			<div
