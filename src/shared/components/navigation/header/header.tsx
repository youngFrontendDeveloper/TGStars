		...
		>
			<div className="flex h-full w-full items-center justify-between p-[24px] lg:px-[50px] lg:py-[15px] lg:backdrop-blur-[78.7px]">
				...
				{user ? (
					...
					<Link
						href={"/auth"}
						className={`font-montserrat order-3 ml-0 items-center rounded-[859px] bg-gradient-to-r from-[#2563EB] to-[#9333EA] px-[18px] py-[10px] text-[16px] font-medium leading-[22.8px] text-white transition-colors duration-300 hover:bg-[#2563EB] hover:from-[#2563EB] hover:to-[#2563EB] xl:ml-[75px]`}
					>
						Войти
					</Link>
				)}
