	...
	return (
		<section className="mb-[48px] flex flex-col md:mb-[58px]">
			...
			<div className="mx-auto flex w-full flex-col gap-[2px] overflow-hidden rounded-[16px] bg-[#E1E8F0] shadow-[0px_0px_11px_0px_#00000005] md:max-w-[670px] md:flex-row">
				<div className="width-full flex flex-col items-center justify-between gap-[17px] rounded-tl-[16px] rounded-tr-[16px] border-[1px] border-[#FFFFFF] bg-[#F7F9FB] p-[24px] md:w-[200px] md:rounded-bl-[16px] md:rounded-tl-[16px] md:rounded-tr-[0] md:px-[15px] md:py-[25px] lg:gap-[24px]">
				...
				<div className="flex flex-1 flex-col gap-[17px] rounded-bl-[16px] rounded-br-[16px] border-[1px] border-[#FFFFFF] bg-[#F7F9FB] p-[24px] md:rounded-bl-[0] md:rounded-bl-[16px] md:rounded-tr-[16px]">
					<div className="flex flex-col gap-[8px]">
						...
						<div className="flex flex-col gap-[8px] md:flex-row">
							...
							<Button
								className="w-full md:w-[97px] md:min-w-[97px]"
